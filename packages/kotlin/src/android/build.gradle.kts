...
android {
    ...
    sourceSets {
        getByName("main") {
            ...
            kotlin.srcDirs("src/main-generated/java")
            assets.srcDirs(
                "../../../alphatab/font/bravura",
                "../../../alphatab/font/sonivox"
            )
        }
        getByName("test") {
            java.srcDirs("src/test-generated/java")
            kotlin.srcDirs("src/test-generated/java")
        }
    }
